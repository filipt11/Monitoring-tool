...
def get_high_utilized_ram(total_memory):
...
def get_average_utilized_ram(total_memory):
...
def get_low_utilized_ram(total_memory):
...
def increase_interface_counter(previous_value, declared_speed, interval=300):
...
def increase_interface_counter_for_higher_utilized(previous_value, declared_speed, interval=300):
